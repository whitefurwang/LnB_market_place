<template>
  <table v-if="now_list && now_list.length" class='table table-hover'>
    <thead>
      <tr>
        <th class="sort" ref='apr' @click='sort_items("apr")'>
          <span>年利率</span>
        ...
        <th class="sort" ref='period' @click='sort_items("period")'>
          <span>期數</span>
          <div class="sort-icons">
            <i class='icon-sort-up'></i>
            <i class='icon-sort-down'></i>
        ...
        <th class="sort" ref='purpose' @click='sort_items("purpose")'>
          <span>貸款目的</span>
          <div class="sort-icons">
            <i class='icon-sort-up'></i>
            <i class='icon-sort-down'></i>
        ...
        <th class="sort" ref='pgr' @click='sort_items("pgr")'>
          <span>保護比例</span>
          <div class="sort-icons">
            <i class='icon-sort-up'></i>
            <i class='icon-sort-down'></i>
        ...
        <th class="sort" ref='expire_at' @click='sort_items("expire_at")'>
          <span>下架倒數</span>
          <div class="sort-icons">
            <i class='icon-sort-up'></i>
            <i class='icon-sort-down'></i>
    ...
    <tbody>
      <router-link
        ...
        data-target="#modal"
      >
        <td class='align-middle'>{{ item.data.loan_detail.credit_level }} {{ item.data.loan_detail.apr.toFixed(2) }}%</td>
